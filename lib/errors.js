...
/**
 * @param {String} msg
 * @param {Object} errOpts
 * @param {String} errOpts.code
 * @param {any} [errOpts.details]
 * @param {Number} errOpts.status
 * @param {Boolean} [errOpts.E_CODE_RETRY]
 * @returns {AuthError}
 */
function create(msg, { status = 0, code = "", details, E_CODE_RETRY }) {
  /** @type AuthError */
  //@ts-ignore
...
function CODE_INVALID(detail) {
  ...
  return create(
    "This verification challenge isn't valid. It may not exist or be expired, or you may have tried too many incorrect codes.",
    {
      status: 400,
      code: "E_CODE_INVALID",
      details: details,
