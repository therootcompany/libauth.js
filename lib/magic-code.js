...
MagicCode.create = function (pluginOpts) {
   ...
   */
  magicCode.verifyCode = async function (
    order,
    code,
    receiptByteCount,
    receiptEncoding,
   ...
   * @param {BufferEncoding} [receiptEncoding]
   */
  magicCode.verifyReceipt = async function (
    order,
    userReceipt,
    receiptByteCount,
    receiptEncoding,
   ...
   */
  magicCode.validate = async function (
    order,
    params,
    receiptByteCount,
    receiptEncoding,
    ...
    if (params.code) {
      validations.code = await magicCode.verifyCode(
        order,
        params.code,
        receiptByteCount,
        receiptEncoding,
    ...
    if (params.receipt) {
      validations.receipt = await magicCode.verifyReceipt(
        order,
        params.receipt,
        receiptByteCount,
        receiptEncoding,
