...
module.exports = function (issuer, PRIVATE_KEY, myOptions) {
  ...
  let opts = {
    ...
    _developmentSendSecretVerificationCode: myOptions._developmentSendSecretVerificationCode,
    // assigned elsewhere
    secret: "",
    logout:
      /**
  ...
  function router() {
    ...
    if (opts._byChallenge) {
      ...
      let routes = require("./magic-link.js").createRouter({
        ...
        _developmentSendSecretVerificationCode: opts._developmentSendSecretVerificationCode,
        //@ts-ignore
