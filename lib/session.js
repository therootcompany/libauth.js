  ...
  if (PRIVATE_KEY) {
    if ("string" === typeof PRIVATE_KEY) {
      try {
        ...
        console.warn(
          "Warn: providing a private key file path is deprecated. Provide a JWK object instead."
        );
      } catch (e) {
        // ignore, probably wasn't a file anyway
        console.warn(
          "Warn: Providing a private key string or file path is deprecated. " +
      ...
      try {
        ...
        throw new Error(
          "Private Key is not in JWK format. " +
