...
LibAuth.create = function (issuer, PRIVATE_KEY, myOptions) {
  ...
  function _credentials(_credOpts) {
    ...
    return promisifyHandler(credentials);
  }
  ...
  function _refresh() {
    /** @type {import('express').Handler} */
    async function _refreshRoute(req, res, next) {
    ...
    return promisifyHandler(_refreshRoute);
  }
  ...
  function _exchange() {
    ...
    return promisifyHandler(_exchangeRoutes);
  }
  ...
  function _setClaims() {
    ...
    return promisifyHandler(setClaims);
  }
  ...
  function _setCookie() {
    ...
    return promisifyHandler(setCookie);
  }
  ...
  function _setTokens() {
    ...
    return promisifyHandler(setTokens);
  }
  ...
  function _redirectWithTokens(redirectUri) {
    ...
    async function _redirecter(req, res, next) {
      ...
      if (errResp?.error) {
        query.error = errResp.error;
      }
      if (errResp?.error_description) {
        query.error_description = errResp.error_description;
      }
      if (errResp?.error_uri || errResp?.error_url) {
        query.error_uri = errResp.error_url || errResp.error_uri;
      }
  ...
  function _getCookie(opts) {
    ...
    return promisifyHandler(getCookie);
  }

  function _requireCookie() {
    return _getCookie({ __required: true });
  }
   ...
   * @returns {import('express').Handler}
   */
  function _getBearer(opts) {
    /** @type {import('express').Handler} */
    async function getBearer(req, res, next) {
    ...
    return promisifyHandler(getBearer);
  }

  function _requireBearer() {
    return _getBearer({ __required: true });
  }
  ...
  function _xoidc(pluginOpts) {
    ...
    /** @type {import('express').Handler} */
    async function setAuthUrl(req, res, next) {
    ...
    return {
      ...
      setAuthUrl: promisifyHandler(setAuthUrl),
