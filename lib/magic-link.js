...
module.exports = function ({
  ...
  app.post("/api/authn/challenge/issue", async function (req, res) {
    ...
    let jwt = await Keypairs.signJwt({
      ...
      iss: iss,
      exp: "20m", // TODO what's a good value here? Also: make configurable
      // optional claims
      claims: claims,
    });
    let result = { success: true, id: id, challenge_token: jwt };
    if (DEVELOPMENT) {
      if (
